...
export type DjangoField = "ID" | "AmountField" | "DecimalField" | "LongCharField" | "MediumCharField" | "ShortCharField" | "ColorField" | "AutoCreatedAtField" | "AutoUpdatedAtField" | "DefaultNowField" | "DefaultTodayField" | "OptionalDateTimeField" | "OptionalDateField" | "ChoiceIntegerField" | "DefaultBooleanField" | "OptionalLimitedTimeField" | "ForeignKey" | "CascadeRequiredForeignKey" | "CascadeOptionalForeignKey" | "SetNullOptionalForeignKey" | "ManyToManyField" | "OptionalManyToManyField" | "OneToOneField" | "OptionalOneToOneField" | "OptionalSetNullOneToOneField" | "OptionalEmailField" | "OptionalURLField" | "LimitedDecimalField" | "OptionalLimitedDecimalField" | "StringArrayField" | "NumberArrayField" | "ChoicesStringArrayField" | "ChoicesNumberArrayField" | "FileField";
export type JsType = "number" | "number[]" | "number | null" | "number[] | null" | "string" | "string[]" | "boolean" | "string | null" | "string[] | null" | "File | null";
export declare const djangoToJsType: Record<DjangoField, JsType>;
